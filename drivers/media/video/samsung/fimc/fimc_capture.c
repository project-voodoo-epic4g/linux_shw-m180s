...
#define V4L2_MODE_PREVIEW		0x00000000	/*  preview mode */ 
#define V4L2_MODE_CAPTURE		0x00000001	/*  capture mode */ 
...
static int fimc_camera_start(struct fimc_control *ctrl)
{
	...
	if (ret < 0) {
		...
		if(ctrl->cam_mode == V4L2_MODE_PREVIEW) {
...
int fimc_s_parm(struct file *file, void *fh, struct v4l2_streamparm *a)
{
	...
	ctrl->cam_mode = a->parm.capture.capturemode;
...
int fimc_streamon_capture(void *fh)
{
	...
	if (ctrl->cam_mode == V4L2_MODE_CAPTURE) {
		struct v4l2_control cam_ctrl;
