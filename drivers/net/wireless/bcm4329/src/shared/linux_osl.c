...
/* USE STATIC BUFFER */
#define USE_STATIC_BUFFER_AT_OSL_ATTACH
...
#ifdef USE_STATIC_BUFFER_AT_OSL_ATTACH
		OSL_MSG_INFO(("use staic skb\n"));
...
#else /* USE_STATIC_BUFFER_AT_OSL_ATTACH */
		for (i = 0; i < MAX_STATIC_PKT_NUM; i++) {
...
#endif /* USE_STATIC_BUFFER_AT_OSL_ATTACH */
#else
...
#ifndef USE_STATIC_BUFFER_AT_OSL_ATTACH
		for(i=0; i<MAX_STATIC_PKT_NUM*2+1; i++) {
