...
#endif /* CONFIG_MACH_S5PC110_CRESPO */
...
#if defined(CONFIG_KOR_MODEL_M180K) || defined(CONFIG_KOR_MODEL_M180W)
static struct regulator_init_data crespo_ldo5_data = {
        .constraints    = {
                .name           = "HREF_2.9V_WIMAX",
                .min_uV         = 2900000,
                .max_uV         = 2900000,
		.always_on	= 1,
                .apply_uV       = 1,
...
int s5k5ccgx_power_reset(struct v4l2_subdev *sd)
{
	s5k5ccgx_power_en(0);
	mdelay(5);
	s5k5ccgx_power_en(1);
...
static struct spi_board_info s3c_spi_devs[] __initdata = {
	[0] = {
		...
		.irq             = IRQ_SPI1,
		.chip_select     = 0,
		.controller_data = &smdk_spi1_csi[0],
	},
};
#endif
...
static void __init max8998_gpio_init(void)
{
	...
	set_irq_type(IRQ_EINT7, IRQ_TYPE_LEVEL_LOW);
}
#endif
...
#if defined(CONFIG_TARGET_LOCALE_KOR) && defined(CONFIG_USB_SWITCH_FSA9480)
	if(!sec_switch_inited)
		fsa9480_enable_irq();
#endif
...
#ifdef CONFIG_KERNEL_DEBUG_SEC
	kernel_sec_clear_upload_magic_number();  // Clear the magic number.
#endif
...
static unsigned int herring_sleep_gpio_table[][3] = {
	...
	{ S5PV210_GPJ1(1), S3C_GPIO_SLP_OUT1,	S3C_GPIO_PULL_NONE},
...
static unsigned int p1_r15_sleep_gpio_table[][3] = {
	{S5PV210_MP01(2),  // EAR_MICBIAS_EN
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{S5PV210_MP05(1),  // EAR_MICBIAS_EN -> NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
};

#if defined(CONFIG_KOR_MODEL_M180K) || defined(CONFIG_KOR_MODEL_M180W)
#if defined(CONFIG_WIMAX) || defined(CONFIG_WIMAX_MODULE)
static unsigned int p1_kt_2w_sleep_gpio_table[][3] = { // make from r10, P1_KT_2W = r15
...
#if 1 // P1_KT, a-port sleep setting to keep self refresh mode
	{S5PV210_GPC0(0),  // APORT_CLK(2W)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPC0(1),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_GPC0(2),  // APORT_CSA(2W)
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE},
	{S5PV210_GPC0(3),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	{S5PV210_GPC0(4),  // APORT_CKE(2W)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
#else
	{S5PV210_GPC0(0),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
...
// This pin is controlled by sound. - GPIO_CODEC_LDO_EN
	...
	{S5PV210_GPG1(0),  // NC -> WIMAX_AP_SDIO_CLK(2W)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG1(1),  // NC -> WIMAX_AP_SDIO_CMD(2W)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG1(2),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	{S5PV210_GPG1(3),  // NAND_D(4) -> WIMAX_AP_SDIO_D(0)(2W)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG1(4),  // NAND_D(5) -> WIMAX_AP_SDIO_D(1)(2W)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG1(5),  // NAND_D(6) -> WIMAX_AP_SDIO_D(2)(2W)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_GPG1(6),  // NAND_D(7) -> WIMAX_AP_SDIO_D(3)(2W)
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
...
// This pin is controlled by sound. - GPIO_MICBIAS_EN
	...
	/* memory part */
	{S5PV210_MP01(0),  // WIMAX_CON0(2W)
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{S5PV210_MP01(1),  // NC -> EAR_MICBIAS_EN(2W)
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP01(2),  // WIMAX_IF_MODE1(2W)
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE},
	{S5PV210_MP01(3),  // WIMAX_IF_MODE0(2W)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP01(4),  // AP_NANDCS
			S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP01(5),  // WIMAX_CON2(2W)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},
	{S5PV210_MP01(6),  // NC
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 
	{S5PV210_MP01(7),  // NC
	...
	{S5PV210_MP02(0),  // UART_SEL1(2W)
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP02(1),  // WIMAX_CON1(2W)
			S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP02(2),  // VCC_1.8V_PDA
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP02(3),  // NC
	...
	{S5PV210_MP05(0),  // WIMAX_SDIO_EN
			S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, //cky 20101123 for level shifter (hw request)
	{S5PV210_MP05(1),  // NC(2W)		
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},
	{S5PV210_MP05(2),  // AP_SCL_1.8V
			S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE}, 
	{S5PV210_MP05(3),  // AP_SDA_1.8V
...
#else /* not CONFIG_WIMAX */
static unsigned int p1_1w_sleep_gpio_table[][3] = {
...
//	s3c_gpio_setpin(GPIO_REMOTE_SENSE_IRQ, 0);
	...
	if(HWREV >= 11) {   // Above P1 KOR Rev0.9 (TOUCH_EN)
		s3c_gpio_cfgpin(GPIO_TOUCH_EN_REV08, S3C_GPIO_OUTPUT);
		s3c_gpio_setpull(GPIO_TOUCH_EN_REV08, S3C_GPIO_PULL_NONE);
		s3c_gpio_setpin(GPIO_TOUCH_EN_REV08, 0);
	}
	else if(HWREV >= 10) {  // Above P1 KOR Rev0.8 (TOUCH_EN)
		s3c_gpio_cfgpin(GPIO_TOUCH_EN_REV08, S3C_GPIO_INPUT);
		s3c_gpio_setpull(GPIO_TOUCH_EN_REV08, S3C_GPIO_PULL_NONE);
...
#if defined(CONFIG_KOR_MODEL_M180K) || defined(CONFIG_KOR_MODEL_M180W)
#if defined(CONFIG_WIMAX) || defined(CONFIG_WIMAX_MODULE)
        s3c_config_sleep_gpio_table(ARRAY_SIZE(p1_kt_2w_sleep_gpio_table),
            p1_kt_2w_sleep_gpio_table);
#else
        s3c_config_sleep_gpio_table(ARRAY_SIZE(p1_1w_sleep_gpio_table),
            p1_1w_sleep_gpio_table);
#endif
#else
...
int __init p1_init_wifi_mem(void)
{
	...
	printk("p1_init_wifi_mem success\n");
	return 0;
...
#endif /* CONFIG_MACH_S5PC110_CRESPO & CONFIG_MACH_P1 */
...
static void herring_init_gpio(void)
{
...
#if defined(CONFIG_KOR_MODEL_M180K) || defined(CONFIG_KOR_MODEL_M180W) // P1_KT, NC alive gpio -> INPUT, PD
#if !defined(CONFIG_WIMAX) && !defined(CONFIG_WIMAX_MODULE)
	s3c_gpio_cfgpin(S5PV210_GPH0(1), S3C_GPIO_INPUT);
	s3c_gpio_setpull(S5PV210_GPH0(1), S3C_GPIO_PULL_DOWN);

	s3c_gpio_cfgpin(S5PV210_GPH0(6), S3C_GPIO_INPUT);
	s3c_gpio_setpull(S5PV210_GPH0(6), S3C_GPIO_PULL_DOWN);
	...
	s3c_gpio_setpull(S5PV210_GPH1(3), S3C_GPIO_PULL_DOWN);
...
#if defined(CONFIG_KOR_MODEL_M180S)
	sprintf(model_str, "SHW-M180S");

	hw_rev += 5;
#elif defined(CONFIG_KOR_MODEL_M180K)
	sprintf(model_str, "SHW-M180K");

	hw_rev = 0xf;
#elif defined(CONFIG_KOR_MODEL_M180W)
	sprintf(model_str, "SHW-M180W");
...
#if defined(CONFIG_KOR_MODEL_M180K) || defined(CONFIG_KOR_MODEL_M180W)
#define GPIO_APORT_CSA			S5PV210_GPC0(2)
#define GPIO_APORT_CKE			S5PV210_GPC0(4)
#define GPIO_APORT_CLK			S5PV210_GPC0(0)

// kyNam_101127_ P1_KT : OneDRAM Control when go to Sleep 
void s3c_config_onedram(void)
{
	unsigned int ucnt = 0;

	printk( KERN_DEBUG "s3c_config_onedram\n" );
	
	// setting the oneDRAM A-Port Sleep Mode
	/************************** 
		GPC0(2): APORT_CSA
		GPC0(4): APORT_CKE
		GPC0(0): APORT_CLK
	***************************/
	...
	s3c_gpio_setpull(GPIO_APORT_CSA, S3C_GPIO_PULL_NONE);
	s3c_gpio_cfgpin(GPIO_APORT_CKE, S3C_GPIO_OUTPUT);
	s3c_gpio_setpull(GPIO_APORT_CKE, S3C_GPIO_PULL_NONE);
	s3c_gpio_cfgpin(GPIO_APORT_CLK, S3C_GPIO_OUTPUT);
	s3c_gpio_setpull(GPIO_APORT_CLK, S3C_GPIO_PULL_NONE);

	s3c_gpio_setpin(GPIO_APORT_CSA, 1); // APORT_CSA
	s3c_gpio_setpin(GPIO_APORT_CLK, 0); // APORT_CLK
	s3c_gpio_setpin(GPIO_APORT_CKE, 1); // APORT_CKE

	s3c_gpio_setpin(GPIO_APORT_CSA, 1); // APORT_CSA
	s3c_gpio_setpin(GPIO_APORT_CLK, 1); // APORT_CLK
	s3c_gpio_setpin(GPIO_APORT_CKE, 1); // APORT_CKE
	...
	s3c_gpio_setpin(GPIO_APORT_CKE, 0); // APORT_CKE
	s3c_gpio_setpin(GPIO_APORT_CSA, 0); // APORT_CSA
...
#if defined(CONFIG_KOR_MODEL_M180K) || defined(CONFIG_KOR_MODEL_M180W)
	// P1_KT, a-port setting to enter self refresh mode
	s3c_config_onedram();
	printk(" ** s3c_config_onedram: set the OneDRAM A-Port\n");
#endif
...
#if defined(CONFIG_KOR_MODEL_M180S)
#define MODEL_NAME "SHW-M180S" 
#elif defined(CONFIG_KOR_MODEL_M180K)
#define MODEL_NAME "SHW-M180K"
#elif defined(CONFIG_KOR_MODEL_M180L)
#define MODEL_NAME "SHW-M180L"
#elif defined(CONFIG_KOR_MODEL_M180W)
#define MODEL_NAME "SHW-M180W"
#else
#error Model name Not specified.
#endif


MACHINE_START(P1, MODEL_NAME)
	.phys_io	= S3C_PA_UART & 0xfff00000,
	.io_pg_offst	= (((u32)S3C_VA_UART) >> 18) & 0xfffc,
	.boot_params	= S5P_PA_SDRAM + 0x100,
	.fixup		= p1_fixup,
...
#if defined(CONFIG_KOR_MODEL_M180K) &&  defined(CONFIG_S3C_DEV_HSMMC1)


static unsigned int wimax_sdio_on_table[][4] = {
        {GPIO_WIMAX_SDIO_CLK, 2, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
        {GPIO_WIMAX_SDIO_CMD, 2, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
        {GPIO_WIMAX_SDIO_D0, 2, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
        {GPIO_WIMAX_SDIO_D1, 2, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
        {GPIO_WIMAX_SDIO_D2, 2, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
        {GPIO_WIMAX_SDIO_D3, 2, GPIO_LEVEL_NONE, S3C_GPIO_PULL_NONE},
};

static unsigned int wimax_sdio_off_table[][4] = {
        {GPIO_WIMAX_SDIO_CLK, 1, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE},
...
#elif defined(CONFIG_S3C_DEV_HSMMC1)
...
#if defined(CONFIG_KOR_MODEL_M180K) || defined(CONFIG_KOR_MODEL_M180W)
		s3c_gpio_slp_setpull_updown(GPIO_WLAN_nRST_R08, S3C_GPIO_PULL_NONE);
#endif		
