...
#ifdef CONFIG_TARGET_LOCALE_KOR_P1_PRIME
extern void max8998_32kHzcp_control(int enable);
#endif
...
void max8998_init(void)
{
	...
	max8998_32kHzcp_control(false);
	#endif /* CONFIG_TARGET_LOCALE_KOR_P1_PRIME */
